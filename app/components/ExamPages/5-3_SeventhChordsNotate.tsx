...
export default function NotateSeventhChords3({
  currentUserData,
  setCurrentUserData,
  nextViewState,
}: UserDataProps) {
        ...
        <Grid container spacing={4} p={2}>
          ...
          <Grid item xs={8} margin={"auto"}>
            ...
            >
              ...
              >
                <Grid item>
                  <Typography variant="h6">
                    {`Write the following seventh chord: ${seventhChordsText[2]}`}
                  </Typography>
                </Grid>
                <Grid item>
                  <NotateChord />
              ...
              <CardFooter pageNumber={20} handleSubmit={handleSubmit} />
            </Box>
          </Grid>
        </Grid>
      </Box>
