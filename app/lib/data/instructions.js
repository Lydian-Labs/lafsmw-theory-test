...
export const scalesNotationInstructions = [
  ...
  {
    instructionTitle: "Place accidentals:",
    instructionText: `After placing notes, click on the "Add Sharp" or "Add Flat" button, then click on the note where you want to add the accidental. To erase, select the “Erase Accidental” button, then click on the note whose accidental you wish to erase.`,
  },
  {
    instructionTitle: "Start over or continue:",
...
export const chordsNotationInstructions = [
  ...
  {
    instructionTitle: "Place accidentals:",
    instructionText: `If the chord has accidentals, after placing notes, click on the "Add Sharp" or "Add Flat" button, then click on the note where you want the accidental to be added. To erase, select the “Erase Accidental” button, then click on the note whose accidental you wish to erase.`,
  },
  {
    instructionTitle: "Start over or continue:",
